...
oob_cal = np.sqrt(mean_squared_error(y_train,rf.predict(X_train)))
oob_val = np.sqrt(mean_squared_error(y_test,rf.predict(X_test)))
...
random_grid = { "bootstrap":[True,False],
                ...
                "min_samples_leaf": list(np.linspace(5,50,10,dtype='i'))+[100,150,200,250,300] }
n_iter = 200
fold=3
